...
def geocode_manage_split_merge(dol_jobs, h2a=True):
    ...
    # accurate_dol_jobs, inaccurate_dol_jobs = helpers.geocode_and_split_by_accuracy(dol_jobs, table="dol_h2a")
    accurate_dol_jobs = pd.DataFrame()
    inaccurate_dol_jobs = pd.read_excel("inaccs_failed.xlsx")
